-- ---------------------------------------------------------------------------
-- Boiler Inspection Management — Supabase setup
...
-- ---------------------------------------------------------------------------
-- Create the login(s) your team will use:
--   Supabase Dashboard → Authentication → Users → "Add user"
--   Enter an email + password (and tick "Auto Confirm User").
-- Then set VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in your host so the
-- app runs in cloud mode and that email/password works on the login page.
-- ---------------------------------------------------------------------------
